...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  // Helper method to build a tagline word with icon - more responsive
  Widget _buildTaglineWord(String text, IconData icon, Color color) {
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            letterSpacing: isSmallScreen ? 0.5 : 1.0,
            shadows: [
              Shadow(
  ...
  // Helper method to build a separator dot - more responsive
  Widget _buildDot() {
    final screenWidth = MediaQuery.of(context).size.width;
    final isSmallScreen = screenWidth < 360;
  ...
  Widget _buildTagline() {
    ...
    Widget taglineWidget = Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(isSmallScreen ? 30 : 50),
        boxShadow: [
          BoxShadow(
      ...
      child: isVerySmallScreen
          // For very small screens, stack the words vertically
          ? Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _buildTaglineWord('Recycle', Icons.recycling, Colors.green.shade300),
                SizedBox(height: 4),
                _buildTaglineWord('Earn', Icons.monetization_on, Colors.amber.shade300),
                SizedBox(height: 4),
                _buildTaglineWord('Shop', Icons.shopping_bag, Colors.blue.shade300),
              ],
            )
          // For normal screens, keep horizontal layout
          : Row(
              mainAxisSize: MainAxisSize.min,
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
