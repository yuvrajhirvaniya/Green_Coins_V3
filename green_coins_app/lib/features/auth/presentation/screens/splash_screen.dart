...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  // Build the tagline widget with animations - with mind-blowing Earth icon
  Widget _buildTagline() {
    ...
    // For v2027 and similar extremely small devices, use a more compact layout
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Earth with rotating globe icon
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                // Simple Earth icon like the first one
                Icon(
                  Icons.public,
    ...
    Widget taglineWidget = Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // Dot separator
          Padding(
            padding: EdgeInsets.symmetric(horizontal: isVerySmallScreen ? 6 : 10),
            child: Container(
